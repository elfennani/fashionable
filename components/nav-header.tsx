...
export default function NavHeader(props: Props) {
  ...
  return (
    <header className="w-full h-20 transition-colors group-has-[.blend]/body:bg-zinc-100">
      <div className="flex relative h-full max-w-[1264px] mx-auto px-8 items-center py-2">
