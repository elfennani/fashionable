...
const ProductCartButton = ({
  ...
  return (
    <button
      onClick={toggle}
      className={cn(
        "flex absolute bottom-0 right-0 md:w-full max-md:self-end translate-y-full font-semibold group-hover:translate-y-0 transition-all items-center justify-center px-2 py-4 gap-3 uppercase tracking-wider leading-none bg-amber-50 md:bg-amber-600 hover:bg-amber-100 hover:md:bg-amber-500 text-amber-600 md:text-amber-50",
        isInCart &&
